        ...
        ScrollView {
            VStack(spacing: 16) {
                ...
                DateNavigationHeader(
                    ...
                    onPrevious: {
                        let prev = Calendar.current.date(byAdding: .day, value: -1, to: calendarViewModel.selectedDate)!
                        calendarViewModel.select(date: prev)
                    },
                    onNext: {
                        let next = Calendar.current.date(byAdding: .day, value: 1, to: calendarViewModel.selectedDate)!
                        calendarViewModel.select(date: next)
                    }
                )
