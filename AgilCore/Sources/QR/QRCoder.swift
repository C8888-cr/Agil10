...
public enum QRCoderError: LocalizedError {
    case encodingFailed
    case decodingFailed
...
public struct QRCoder {
    ...
    public func encode(_ payload: QRPayload) throws -> String {
        do {
    ...
    public func decode(_ string: String) throws -> QRPayload {
