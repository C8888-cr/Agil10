...
struct KGGVideoCryptor {

    // MARK: - Format-Konstanten (Single Source of Truth)
    static let magic = Data("AGKV".utf8)          // 4 Bytes
    static let version: UInt8 = 1
    static let defaultChunkSize = 1 * 1024 * 1024 // 1 MB Klartext pro Chunk

    enum CryptorError: LocalizedError {
    ...
    init(chunkSize: Int = KGGVideoCryptor.defaultChunkSize) {
    ...
    func encrypt(sourceURL: URL, to destinationURL: URL, using key: SymmetricKey) throws {
