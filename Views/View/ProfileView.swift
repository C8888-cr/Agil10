...
struct ProfileView: View {
    ...
    private var praxisId: UUID? { currentUser?.praxisId }
        ...
        NavigationStack {
            ...
            Form {
                if let user = currentUser {
                    ...
                    // ✅ PRAXIS SECTION - KORRIGIERT
                                      Section("Praxis") {
                                          if let praxisId = praxisId,
                                             let praxis = PraxisDataManager.shared.getPraxis(by: praxisId) {
                                              
                                              // Praxis-Name als Header
                                              HStack {
                                                  Label("Praxis", systemImage: "building.2.fill")
                                                  Spacer()
                                                  Text(praxis.name)
                                                      .font(.subheadline.bold())
                                              ...
                                              // ✅ Fallback wenn keine Praxis zugeordnet
                                              HStack {
                                                  Label("Praxis", systemImage: "building.2")
                                                  Spacer()
                                                  Text("Keine zugeordnet")
                                                      .foregroundStyle(.secondary)
                                              }
                                          }
                                      }
